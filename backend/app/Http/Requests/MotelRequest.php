...
class MotelRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'electricity_fee' => $isUpdate ? 'sometimes|required|integer|min:1000' : 'required|integer|min:1000',
            'water_fee' => $isUpdate ? 'sometimes|required|integer|min:1000' : 'required|integer|min:1000',
            'parking_fee' => $isUpdate ? 'sometimes|required|integer|min:1000' : 'required|integer|min:1000',
            'junk_fee' => $isUpdate ? 'sometimes|required|integer|min:1000' : 'required|integer|min:1000',
            'internet_fee' => $isUpdate ? 'sometimes|required|integer|min:1000' : 'required|integer|min:1000',
            'service_fee' => $isUpdate ? 'sometimes|required|integer|min:1000' : 'required|integer|min:1000',
