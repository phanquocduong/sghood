    ...
    <div class="container-fluid py-5 px-4">
        <div class="card shadow-lg border-0" style="border-radius: 15px; background: #fff;">
            <div class="card-header bg-gradient text-white d-flex justify-content-between align-items-center"
                ...
                <div>
                    <a href="{{ route('rooms.index', ['motel_id' => $motelId]) }}" class="btn btn-secondary shadow-sm"
                    ...
                    <form action="{{ route('rooms.trash') }}" method="GET" class="row g-3">
                        ...
                        <div class="col-md-3">
                            <select class="form-select shadow-sm" name="status" onchange="this.form.submit()">
                                ...
                                <option value="maintenance" {{ $status == 'maintenance' ? 'selected' : '' }}>Sửa chữa
                                </option>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered align-middle text-center">
                        ...
                        <tbody>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            <form action="{{ route('rooms.restore', $room->id) }}" method="POST"
                                                ...
                                                @csrf
                                                @method('POST')
                                                <button type="submit" class="btn btn-sm btn-success action-btn me-2"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">Không có phòng trọ nào trong
                                        thùng rác.</td>
                                </tr>
                            @endforelse
                        </tbody>
