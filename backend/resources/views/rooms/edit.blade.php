            ...
            <form action="{{ route('rooms.update', $room->id) }}" method="POST" enctype="multipart/form-data" id="roomForm" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="number" class="form-control shadow-sm @error('max_occupants') is-invalid @enderror" id="max_occupants" name="max_occupants" value="{{ old('max_occupants', $room->max_occupants) }}" min="1" required>
                        @error('max_occupants')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
