            ...
            <div class="card border-0 shadow-sm h-100 stat-card">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <h5 class="mb-0 fw-semibold text-dark">15 / 25</h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-header bg-gradient border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <form action="{{ route('notes.index') }}" method="GET">
                            <button type="submit" class="btn btn-link text-decoration-none p-0 small">Xem tất cả</button>
                        </form>
                    </div>
                </div>
                    ...
                    <ul class="list-group list-group-flush">
                        @isset($notes)
                            @forelse($notes->take(3) as $note)
                                <li class="list-group-item border-0 py-3" data-id-user="{{ $note->user_id }}" data-note-id="{{ $note->id }}">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                            ...
                            @endforelse
                        @else
                            <li class="list-group-item border-0 text-center text-muted py-4">Chưa tải được ghi chú: {{ session('error') ?? 'Lỗi không xác định' }}</li>
                        @endisset
                    </ul>
                </div>
            </div>
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item border-0 py-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0 me-3">
                                    <div class="bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
