            ...
            <div class="card-header bg-gradient text-white d-flex justify-content-between align-items-center"
                ...
                <div class="d-flex align-items-center">
                    <h6 class="mb-0 fw-bold">{{ __('Danh sách giao dịch') }}
                        <span class="badge bg-light text-primary ms-2">{{ $transactions->total() ?? 0 }} bản ghi</span> <span class="fst-italic text-danger"> Chi tiết: <a href="https://my.sepay.vn/transactions" target="_blank">Sepay</a></span>
                    </h6>
                </div>
            </div>
