    ...
    <div class="container-fluid py-5 px-4">
        <div class="card shadow-lg border-0" style="border-radius: 15px; background: #fff;">
            <div class="card-header bg-gradient text-white d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center"
                ...
                <h6 class="mb-2 mb-sm-0 fw-bold w-100 text-start text-sm-start">{{ __('Danh sách khu vực') }}</h6>
                <div class="d-flex flex-row w-100 w-sm-auto justify-content-between justify-content-sm-end">
                    <a href="{{ route('districts.create') }}" class="btn btn-primary me-2 shadow-sm w-50 w-sm-auto"
                        ...
                        <div class="col-md-2">
                            <select name="sortOption" class="form-select shadow-sm" onchange="this.form.submit()">
                                <option value="created_at_desc"
                                    {{ request('sortOption') == 'created_at_desc' ? 'selected' : '' }}>Sắp xếp theo</option>
                                <option value="name_asc" {{ request('sortOption') == 'name_asc' ? 'selected' : '' }}>Tên
                                    A-Z</option>
                                <option value="name_dsc" {{ request('sortOption') == 'name_dsc' ? 'selected' : '' }}>Tên
                                    Z-A</option>
