    ...
    <table class="container" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td class="content">
                ...
                <p>Chúng tôi vừa nhận được một lịch xem nhà trọ mới từ hệ thống. Vui lòng kiểm tra và xử lý trong thời gian sớm nhất.</p>
                <table class="details-table">
                    <tr>
                        <td class="label">Mã lịch</td>
                        <td class="highlight">{{ $schedule->id }}</td>
                    </tr>
                    <tr>
                        <td class="label">Người dùng</td>
                        <td class="highlight">{{ $schedule->user->name }}</td>
                    </tr>
                    <tr>
                        <td class="label">Nhà trọ</td>
                        <td class="highlight">{{ $schedule->motel->name }}</td>
                    </tr>
                    <tr>
                        <td class="label">Thời gian lịch</td>
                        <td class="highlight">{{ $schedule->scheduled_at->addHours(7)->format('d/m/Y H:i') }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="highlight">{{ $schedule->status }}</td>
                    </tr>
                    <tr>
                        <td class="label">Thời gian gửi</td>
                        <td class="highlight">{{ $schedule->created_at->addHours(7)->format('d/m/Y H:i:s') }}</td>
                    </tr>
                </table>
