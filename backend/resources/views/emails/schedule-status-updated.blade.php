...
<body>
    <div class="container">
        ...
        <div class="details">
            ...
            <p><strong>Thời gian:</strong> {{ \Carbon\Carbon::parse($schedule->scheduled_at)->format('H:i - d/m/Y') }}</p>
        ...
        @elseif($newStatus == 'Huỷ bỏ')
            ...
            <p>🔄 Đừng lo lắng! Bạn có thể đặt lịch mới bất cứ lúc nào hoặc liên hệ trực tiếp với chúng tôi để được hỗ trợ tốt nhất.</p>
        ...
        <p>💬 Có bất kỳ thắc mắc nào? Đừng ngại liên hệ với chúng tôi qua email hoặc hotline. Chúng tôi luôn sẵn sàng hỗ trợ bạn!</p>
