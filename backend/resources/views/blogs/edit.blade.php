            ...
            <div class="card-body p-4">
                <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-3">
                            <img id="preview-thumbnail" src="{{ $blog->thumbnail }}" alt="Thumbnail preview"
                                style="max-width: 200px; border: 1px solid #ddd; padding: 4px; border-radius: 4px;">
                        </div>
                        @error('thumbnail')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror content" id="content" name="content"
                            rows="5" required>{{ old('content', $blog->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="d-flex justify-content-end mt-4 gap-2">
                        ...
                        <input type="submit" class="btn btn-primary shadow-sm" value="Cập nhật bài viết"
