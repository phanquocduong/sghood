        ...
        <div class="card-body p-4">
            <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('content') is-invalid @enderror content" id="content"  name="content" rows="5" required>{{ old('content') }}</textarea>
                     @error('content')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="d-flex justify-content-end mt-4 gap-2">
                    ...
                    <input type="submit" class="btn btn-primary shadow-sm" value="Thêm bài viết" style="transition: all 0.3s;"/>
                </div>
            </form>
        </div>
    </div>
