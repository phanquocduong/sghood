                ...
                <tbody>
                    ...
                    @foreach($blogs as $blog)
                        <tr class="table-row">
                            ...
                            <td>
                                @if($blog->thumbnail)
                                    <img src="{{ asset($blog->thumbnail) }}" alt="{{ $blog->title }}" class="img-fluid rounded motel-image" style="max-height: 80px; object-fit: cover; transition: transform 0.3s;">
                                @else
                            ...
                            <td>
                                 <a href="{{ route('blogs.edit', $blog->id) }}" class="btn btn-sm btn-primary action-btn me-2" style="transition: all 0.3s;">
