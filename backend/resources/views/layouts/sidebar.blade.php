...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <!-- Quản lý hệ thống -->
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle {{ request()->is('area.html') || request()->is('motels*') || request()->is('amenity.html') ? 'active' : '' }}" data-bs-toggle="dropdown"><i class="fa fa-cogs me-2"></i>Hệ thống</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="area.html" class="dropdown-item {{ request()->is('area.html') ? 'active' : '' }}">Khu vực</a>
