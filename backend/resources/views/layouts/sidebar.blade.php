...
<div class="navbar-nav w-100">
    ...
    <div class="nav-item dropdown {{ request()->routeIs('schedules.*') || request()->routeIs('contracts.*') || request()->routeIs('bookings.*') ? 'show' : '' }}">
        ...
        <div class="dropdown-menu bg-transparent border-0 {{ request()->routeIs('schedules.*') || request()->routeIs('contracts.*') || request()->routeIs('bookings.*') ? 'show' : '' }}">
            ...
            <!-- Quản lý hệ thống -->
            <div class="nav-item dropdown {{ request()->routeIs('districts.*') || request()->routeIs('motels.*') || request()->routeIs('amenities.*') || request()->routeIs('rooms.*') || request()->routeIs('configs.*') ? 'show' : '' }}">
                ...
                <div class="dropdown-menu bg-transparent border-0 {{ request()->routeIs('districts.*') || request()->routeIs('motels.*') || request()->routeIs('amenities.*') || request()->routeIs('rooms.*') || request()->routeIs('configs.*') ? 'show' : '' }}">
