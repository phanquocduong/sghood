...
<div class="container-fluid py-5 px-4">
    <div class="card shadow-lg border-0" style="border-radius: 15px; background: #fff;">
        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('admin.updateUser', ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data" id="userEditForm" novalidate>
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-12">
                ...
                <div class="d-flex justify-content-end mt-4 gap-2">
                    <a href="{{ route('admin.users') }}" class="btn btn-secondary shadow-sm" style="transition: all 0.3s;">Trở lại</a>
