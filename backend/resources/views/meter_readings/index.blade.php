...
@section('content')
        ...
        <div class="card shadow-lg border-0" style="border-radius: 15px;">
            <div class="card-header bg-gradient text-white d-flex justify-content-between align-items-center"
                ...
                <div class="d-flex align-items-center">
                    <a href="{{ route('meter_readings.history') }}" class="btn btn-outline-dark btn-sm me-2">
            ...
            <div class="card-body p-4">
                ...
                @if($shouldDisplayTable && $rooms && $rooms->isNotEmpty())
                    <!-- Show rooms available for meter reading input -->
                    <div class="accordion" id="displayIndex">
                        ...
                        @forelse ($rooms as $motelId => $groupedRooms)
                            <div class="accordion-item">
                                ...
                                <div id="motelCollapse{{ $motelId }}" class="accordion-collapse collapse show"
                                    aria-labelledby="motelHeading{{ $motelId }}" data-bs-parent="#displayIndex">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('meter_readings.store') }}" method="POST" id="updateMeterForm">
                    ...
                    <div class="modal-body">
                        ...
                        <p style="color:red;">*Chỉ số tháng này không được nhỏ hơn chỉ số tháng trước</p>
        ...
        <div class="row g-2">
            <div class="col-md-6">
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" step="0.01" min="${room.previous_electricity || 0}" max="99999" name="readings[${globalIndex}][electricity_kwh]" class="form-control ${electricityError ? 'is-invalid' : ''}" placeholder="0.00" required aria-label="Chỉ số điện cho phòng ${room.name}">
                </div>
            ...
            <div class="col-md-6">
                <div class="input-group input-group-sm">
                    ...
                    <input type="number" step="0.01" min="${room.previous_water || 0}" max="99999" name="readings[${globalIndex}][water_m3]" class="form-control ${waterError ? 'is-invalid' : ''}" placeholder="0.00" required aria-label="Chỉ số nước cho phòng ${room.name}">
                </div>
    ...
    `;
            ...
            // Event listeners for edit room buttons
            function bindEditRoomButtons() {
