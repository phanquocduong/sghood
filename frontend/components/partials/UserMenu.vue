  ...
  <div class="right-side">
    <div class="header-widget">
      ...
      <a
        v-if="!user"
        href="#sign-in-dialog"
        class="sign-in popup-with-zoom-anim" style="margin-left: auto;"
      >
        ...
        <div v-if="user" class="auth-container">
          ...
          <div class="user-menu">
            ...
            <ul>
              ...
              <li>
                <NuxtLink to="/quan-ly/ho-so-ca-nhan">
                  <i class="sl sl-icon-user"></i> Hồ sơ cá nhân
                </NuxtLink>
              </li>
              <li>
              ...
              <li>
                <a href="#" @click.prevent="authStore.logout">
                  <i class="sl sl-icon-power"></i> Đăng xuất
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="user-menu notification-wrapper">
            ...
            <ul v-if="showDropdown" class="dropdown">
              <li><a href="#"><i class="fa fa-envelope"></i> Tin nhắn mới</a></li>
              <li><a href="#"><i class="fa fa-calendar-check-o"></i> Đặt phòng mới</a></li>
              <li><a href="#"><i class="fa fa-check-circle"></i> Xác nhận email</a></li>
            </ul>
          </div>
        </div>
      </ClientOnly>
