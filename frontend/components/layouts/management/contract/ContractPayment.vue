<template>
    <div class="payment-section">
        <div class="header">
            <h2><i class="fas fa-check-circle"></i> Hợp đồng đã được ký thành công</h2>
            <p class="contract-id">Mã hợp đồng #{{ contract.id }}</p>
        </div>
        <div class="payment-methods">
            <h3>Hướng dẫn thanh toán tiền cọc</h3>
                    ...
                    <div class="bank-info">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <span class="value">{{ formatCurrency(contract.deposit_amount) }}đ</span>
                            </div>
                            <div class="info-item">
                        ...
                        <p class="note">
                            <i class="fas fa-info-circle"></i> Lưu ý: Vui lòng giữ nguyên nội dung chuyển khoản
